                ...
                <div class="col-lg-9 blog-post-single">
                    <div class="blog-item">
						<div class="image-blog">
							<img src="resources/images/blog_single.jpg" alt="" class="img-fluid">
						</div>
					...
					<div class="blog-author">
						...
						<div class="author-desc">
							<img src="resources/images/author.jpg" alt="about author">
        ...
        <div class="container">
            <div class="row logos">
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="resources/
					resources/images/logo_01.png" alt="" class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-center">                   
                    <p class="footer-company-name">All Rights Reserved. &copy; 2018 <a href="#">SmartEDU</a> Design By :Mariham & Salma</a></p>
                </div>
            </div>
        </div><!-- end container -->
    </div><!-- end copyrights -->
